...
import 'package:movie_bonie/features/movies/domain/movie_detail.dart';
...
class MovieRepository {
  ...
  Future<MovieDetail> fetchMovieDetail(String id) async {
    ...
    if (response.statusCode == 200 && response.data['Response'] == 'True') {
      // MovieDetail.fromJson을 사용하여 파싱
      return MovieDetail.fromJson(response.data);
    } else {
      throw Exception('Failed to load movie detail: ${response.data['Error']}');
    }
  }
}
